/*!
 * JavaScript Class Library v0.5.0 (JSC v0.5.0)
 *
...
(function(undefined){
    var
        ...
        /**
         * Core library entry. Creates a class with inheritance, polymorphism, overriding, etc.
        ...
        JSC = function(className, defs) {
            ...
            Class.self = function(methodName) {
                this.body = JSC.isString(methodName) ? this[methodName] : methodName || this.getInstance;
                return this;
            };
            Class.rename = function(className) {
                this.prototype.className = this.className = className || _defaultClassName;
                return this;
            };
         ...
         */
        JSCError = function(message, context) {
            this.message = message;
            this.context = context;
        };

    // Custom error class have to inherit from system error class
     ...
     */
    JSC.install = function(pluginName, defs) {
     ...
     */
    JSC.isInstalled = function(pluginName, defs) {
        // all parameters can be given in one single object
        if( pluginName && !JSC.isString(pluginName) ) {
            defs = pluginName;
            pluginName = defs.pluginName;
     ...
     */
    JSC.uninstall = function(pluginName, defs) {
        var context, name, backup, target;

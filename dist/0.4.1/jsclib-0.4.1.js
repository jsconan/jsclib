...
(function(undefined){
    ...
    var JSC = {
        ...
        Make : function(type, defs, statics, globalize) {
            ...
            // set the class as self factory if no class body is find
            Class.body = Class.body || Class.getInstance;
        ...
        /**
         * Set a class as self factory
         *
         * @param {Function} Class The class to set as self factory
         * @return {Function} Return the given class
         */
        Self : function(Class) {
            if( JSC.isClass(Class) ) {
                Class.body = Class.getInstance;
            }
            return Class;
        },
